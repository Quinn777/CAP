...
parser.add_argument("--evl_distance", type=str, default="l_inf", choices=("l_inf", "l_2"),
...
parser.add_argument('--helper_model', type=str, default="/best_clean_model.pth.tar",
                    help='Helper model weights file name for HAT.')
...
# CAP
parser.add_argument('--cap_gamma', default=0.0001, type=float, help='whether or not to add parametric noise')
parser.add_argument('--cap_warmup', default=20, type=int, help='We could apply CAP after some epochs for accelerating.')
